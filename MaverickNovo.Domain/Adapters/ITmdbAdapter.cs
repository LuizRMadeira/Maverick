...
namespace MaverickNovo.Domain.Adapters
{
    public interface ITmdbAdapter
    {
        ...
        /// <param name="idioma">Idioma da pesquisa/resultado</param>
        /// <returns>
        ///     Lista das pessoas e seus filmes encontrados conforme criterio de pesquisa.
        /// </returns>
        /// <exception cref="Exceptions.BuscarFilmesCoreException" />
        Task<IEnumerable<Pessoa>> GetFilmesPorPessoaAsync(PesquisaPorPessoa pesquisa, string idioma);
  }
}
